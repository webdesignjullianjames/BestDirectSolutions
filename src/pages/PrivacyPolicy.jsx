...
export default function PrivacyPolicy() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: 'linear-gradient(180deg, rgba(10, 10, 10, 0.45) 0%, rgba(10, 10, 10, 0.6) 40%, rgba(13, 15, 18, 0.8) 100%), url("/Company Images/webp/privacy-policy-hero.webp")',
